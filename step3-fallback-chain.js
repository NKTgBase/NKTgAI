...
setTimeout(() => {
    ...
    // Hệ thống đã sẵn sàng nhận input — hiện logo hố đen (galaxy canvas)
    const galaxy = document.getElementById('nktgGalaxy');
    if (galaxy) galaxy.style.visibility = 'visible';
}, 0);
